...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help ="Input artifact to be cleaned",## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type =str,## INSERT TYPE HERE: str, float or int,
        help ="Name of the output cleaned artifact", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        ...
        help ="Minimum price filter", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type =float, ## INSERT TYPE HERE: str, float or int,
        help ="Maximum price filter", ## INSERT DESCRIPTION HERE,
        required = True
    )
